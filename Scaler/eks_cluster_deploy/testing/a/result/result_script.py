...
for ms in ms_names:
    with open(f"{path}/kb/{ms}.txt", "r") as file:
        for line in file:
...
for ms in ms_names:
    ...
    # filter data with test time > 800
    filter_data = [data for data in original_data if data["test_time"] < 800]
...
print(total_capacity_cpu_each_rep)
