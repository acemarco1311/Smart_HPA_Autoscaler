...
if __name__ == "__main__":
    ...
    failure_two = threading.Thread(target=manager_failure_injection,
                                   args=("currencyservice", 30, 600,))
    failure_three = threading.Thread(target=manager_failure_injection,
                                     args=("cartservice", 30, 600,))
    failure.start()
    failure_two.start()
    failure_three.start()
