...
class MicroserviceManager:
    ...
    def __init__(self, microservice_name, min_reps, max_reps,
        ...
        # restore state using K8s deployment
        #current_rep = None
        #while current_rep is None:
        #    current_rep = get_available_reps(self.microservice_name)
        #if current_rep > self.max_reps:
        #    self._current_arm_max_reps = current_rep

        # state recovery from EFS
